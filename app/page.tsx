        ...
        <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="dp-panel rounded-[32px] p-6">
            <div className="flex items-center gap-5">
              <div className="flex h-28 w-28 items-center justify-center rounded-[28px] border border-dp-border-secondary bg-gradient-to-br from-dp-orange via-dp-orange-dark to-dp-lime text-3xl fo[...]
                DP
              </div>
              <div>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          <form className="dp-panel rounded-[32px] p-6">
            <div className="grid gap-4 sm:grid-cols-2">
              <label className="space-y-2">
                ...
                <input className="w-full rounded-2xl border border-dp-border-secondary bg-dp-bg-3 px-4 py-3 text-dp-text-primary outline-none ring-0 placeholder:text-dp-text-dark focus:border-dp-[...]
              </label>
              <label className="space-y-2">
            ...
            <label className="mt-4 block space-y-2">
              ...
              <textarea className="min-h-44 w-full rounded-2xl border border-dp-border-secondary bg-dp-bg-3 px-4 py-3 text-dp-text-primary outline-none ring-0 placeholder:text-dp-text-dark focus:[...]
            </label>
          ...
          <aside className="dp-panel rounded-[32px] p-6">
            ...
            <div className="mt-6 space-y-4 text-sm text-dp-text-secondary">
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-dp-border-secondary bg-dp-bg-3 px-4 py-3"><MessageSquareText size={16} className="text-dp-rose" /> Available for fr[...]
            </div>
            <Link href="mailto:hello@devpilot.dev" className="mt-8 inline-flex items-center gap-2 rounded-full border border-dp-border-secondary px-5 py-3 text-sm font-medium text-dp-text-primary[...]
              hello@devpilot.dev
            </Link>
          </aside>
        </div>
